...
describe('Notification content', () => {
    ...
    test(' should not be able to create a notification content whith less than 5 characters', () => {
        // espero que esteja tudo ok
        expect(()=> new Content('sds')).toBeTruthy();
    })
    
    // espero que não seja possivel criar o conteudo da notificação com mais de 240 caracteres
    test('ishould not be able to create a notification content whith less than 5 characters', () => {
        // espero que esteja tudo ok
